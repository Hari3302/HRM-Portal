...
export default function PrimarySearchAppBar({head}) {
      ...
      <AppBar  >
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
           ...
           <Avatar alt="Remy Sharp" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4q4mFHHqJPdZqQwAVzpn0GDYxm5ROVB-ueb6ZmeyI-JU08b7_JBsoq-sp5Q&s" />
           </Stack>
            </IconButton>
          </Box>
