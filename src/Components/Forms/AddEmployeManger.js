...
function AddEmployeeManager() {
  ...
  const signupSubmit = async () => {
    ...
    try {
      await dataAxios.post("empmanagerdetails", {
        empmanger_name: name,
        ...
        empmanger_sslc: sslc,
        empmanger_hsc: hsc,
        empmanger_degree: degree,
        empmanger_experience: exper,
      });

      await dataAxios.post("loginDetails", {
        user_name: userName,
        user_type: "empmanger",
        phone_number: phnumber,
        emailid: email,
      ...
      console.log("object");
      alert("You have Succesfully Created the Employee manager");
    } catch (err) {
      console.log(err);
    }
  };
          ...
          <Box sx={{ marginTop: 5 }}>
            ...
            <div className="text-feild">
              <TextField
                ...
                size="small"
                placeholder=" BranchWith Percentage"
                onChange={(e) => {
