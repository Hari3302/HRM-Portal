...
const datas =await dataAxios.post("hrdetails",{hr_name:name,phone_number:phnumber,emailid:email,user_name:userName,password:password,hr_sslc:sslc,hr_hsc:hsc,hr_degree:degree,hr_experience:exper,company_name:company_name})
console.log("object",datas) 
alert("You have Succesfully Created the HR")  
await
            ...
            <div className="text-feild">
              ...
              <div className="text-feild">
               <TextField
                className="input-field"
                size="small"
                placeholder=" No of Work Experience in Years"
